...
The `RooseveltAdvisors.herdr-sesh.last` action switches to the previously focused workspace,
...
!!! note "Prerequisite"
    ...
    `herdr plugin install RooseveltAdvisors/herdr-plugin-sesh --ref <release-tag>` using
    a tag from the
    [GitHub releases](https://github.com/RooseveltAdvisors/herdr-plugin-sesh/releases)
    page.
